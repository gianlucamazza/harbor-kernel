...
| [ADR-0099](adr/0099-composition-vocabulary.md)                       | Declared `held` vocabulary in `kernel_core::held`; `bind` over `Option`; `HeldVacant`; `bootstrap::authority` (**accepted**); done (QEMU)                        |
