...
| **H2 depth**                 | K4 EL0+EL1 preemption done (HW); K7 first slice done (HW); K8 unpark+IPI+queues+preempt-cpu1 done (HW, stamps 2026-08-10); residual steal / EL0-on-CPU1; K7 TTBR1 |
| **open (kernel)**            | K8 steal · EL0-on-CPU1; K7 residuals (TTBR1 / switch-cost); K5 driver-half                                            |
