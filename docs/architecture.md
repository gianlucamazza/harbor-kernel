...
| **H2 depth**                 | K4 EL0+EL1 preemption done (HW); K7 first slice done (HW); K8 unpark+IPI+queues+preempt-cpu1 done (HW); EL0-on-CPU1 done (QEMU, ADR-0081); residual HW stamp / steal; K7 TTBR1 |
| **open (kernel)**            | K8 EL0-on-CPU1 **HW stamp**; steal; K7 residuals (TTBR1 / switch-cost); K5 driver-half                                            |
...
| [ADR-0081](adr/0081-k8-el0-on-cpu1-first-slice.md)                   | K8 fifth slice — EL0 on CPU 1 (**accepted**); done (QEMU)                                                                                              |
