...
| **H1 next**                  | P3 network implementation for the accepted edge-gateway target ([ADR-0104](adr/0104-p3-edge-network-composition.md)); P2 durable endpoint shipped in [ADR-0103](adr/0103-p2-el0-durable-endpoint.md)                                                                                           |
...
| **open (product)**           | P3 implementation follows accepted [ADR-0104](adr/0104-p3-edge-network-composition.md); P4 remains deferred (ADR-0049); denser composition (K5-H if slots bind); console server remains compiled-in EL1 infrastructure |
