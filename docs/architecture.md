...
| **H1 next**                  | P3\|P4 composition residuals; P2 durable endpoint shipped in [ADR-0103](adr/0103-p2-el0-durable-endpoint.md)                                                                                           |
...
| **open (product)**           | P3/P4 deferred (ADR-0049); denser composition (K5-H if slots bind); console server remains compiled-in EL1 infrastructure                                      |
