...
| **open (product)**           | Pi4 backend evidence for the QEMU-complete P3 target follows [ADR-0105](adr/0105-pi4-nic-backend-boundary.md); P4 remains deferred (ADR-0049); denser composition (K5-H if slots bind); console server remains compiled-in EL1 infrastructure |
