...
| **H2 depth**                 | K4 EL0+EL1 preemption done (HW); K7 first slice done (HW); K8 unpark+IPI+queues+EL1/EL0 preempt-cpu1 done (HW, stamps 2026-08-10); residual steal; K7 TTBR1 |
| **open (kernel)**            | K8 steal; K7 residuals (TTBR1 / switch-cost); K5 driver-half                                            |
