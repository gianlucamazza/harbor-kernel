...
| **H2 depth**                 | K4 EL0+EL1 preemption done (HW); K7 first slice done (HW); K8 unpark+IPI+queues+preempt-cpu1 done (HW, stamps 2026-08-10); EL0-on-CPU1 design ADR-0080 (code residual); residual steal; K7 TTBR1 |
| **open (kernel)**            | K8 EL0-on-CPU1 **code** (design ADR-0080); steal; K7 residuals (TTBR1 / switch-cost); K5 driver-half                                            |
...
| [ADR-0080](adr/0080-k8-el0-on-cpu1-design.md)                        | K8 design — EL0 sessions/agents home on CPU 1 (**accepted**); code residual                                                                            |
