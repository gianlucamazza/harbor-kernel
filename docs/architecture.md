...
| **H2 depth**                 | K4 EL0+EL1 preemption done (HW); K7 first slice done (HW); K8 unpark+IPI+queues first done (HW, stamp 2026-08-10); K8 per-core timer+EL1 preempt done (QEMU, ADR-0079); residual steal / EL0-on-CPU1 / HW stamp; K7 TTBR1 |
| **open (kernel)**            | K8 preempt-cpu1 **HW stamp**; steal · EL0-on-CPU1; K7 residuals (TTBR1 / switch-cost); K5 driver-half                                            |
...
| [ADR-0079](adr/0079-k8-per-core-timer-preemption-first-slice.md)     | K8 fourth slice — per-core timer + EL1 preempt on CPU 1 (**accepted**); done (QEMU)                                                                    |
