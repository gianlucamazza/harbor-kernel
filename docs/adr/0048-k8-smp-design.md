...
Residual (live): agent/TLB steal second slice only if needed — first steal
**done (HW)** [ADR-0083](0083-k8-work-stealing-first-slice.md) (design
[0082](0082-k8-work-stealing-design.md); stamp 2026-08-10,
`20260810-144305.log`). Per-core EL1 preempt **done (HW)** via
[ADR-0079](0079-k8-per-core-timer-preemption-first-slice.md); EL0-on-CPU1
**done (HW)** via [ADR-0081](0081-k8-el0-on-cpu1-first-slice.md).
