...
`Genet::probe`. Silicon stamp `20260814-232303.log` boot 5 (`src=6addf8f4`, PowerOn)
...
`genet: reset recovered (idle, not a nic)`, and `VACANT`. UniMAC
max-frame and station address ran; the attached laptop Apple NIC
