...
| ---- | ---------------------------------------------------- | ---------------------------------------- |
| 1    | **EL0-on-CPU1** **HW stamp** ([ADR-0081](adr/0081-k8-el0-on-cpu1-first-slice.md)) | QEMU paid; close silicon residual        |
...
Mission: agents · grants · evidence · finish the OS
    ...
    H1 composition ████████ done (HW) stamp 2026-08-08
                │
    H2 boundary    ████████ K4+K8; EL0-on-CPU1 done (QEMU)
                │
