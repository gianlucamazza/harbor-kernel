...
|  next | **GENET link classify**                               | BMSR up/down after identify. Still no DMA, no vocabulary bind. Host `PhyLink::classify_bmsr` already exists. Not a NIC; gated by [ADR-0105](adr/0105-pi4-nic-backend-boundary.md). | — |
