...
|  next | **P2 EL0 storage** — a service on an endpoint             | The product can bind a name. What it cannot yet do is offer storage to an agent: put/get are EL1 only ([ADR-0036](adr/0036-p2-keyed-blob-store.md)). An endpoint an agent can send to is the remaining item ADR-0099 named, and the shape a later P3/P4 composition will copy                                                     | —                                                               |
...
- `spinner exited`). **K8 steal** **done (HW)**
  ...
  **Next:** services on endpoints (what the product binds). Held: K5-H until
