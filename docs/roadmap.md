...
|  next | **GENET queue-0 program**                             | Write queue-0 descriptors (`configure_queue0` / `DmaPhase::Programmed`). Queues stay disabled. Still no TX/RX, no vocabulary. Host model already exists. Gated by [ADR-0105](adr/0105-pi4-nic-backend-boundary.md). | — |
