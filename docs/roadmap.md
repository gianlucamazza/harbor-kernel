...
| P3  | Network agent + caps                    | **composition accepted; transport contract first slice implemented** — host-tested modern feature negotiation, split-queue arithmetic, and bounded packet ownership ([ADR-0104](adr/0104-p3-edge-network-composition.md)); AArch64 QEMU `virt` virtio-mmio integration remains open                                                                                                                                                                                                 | Network I/O only via granted caps                    | K1/K9 helpful      | H1 edge → H2 |
