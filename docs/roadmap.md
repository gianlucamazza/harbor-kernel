...
|  next | **GENET UniMAC frame**                                | After RGMII OOB, write `UMAC_MAX_FRAME_LEN` and station `UMAC_MAC0`/`UMAC_MAC1` (LAA `02:00:00:00:00:01`, same as the probe frame). Host-tested. QEMU has no successful probe. Silicon unpaid. Not a NIC; ADR-0105/0106 stay proposed. | — |
