...
|  next | **GENET queue-0 enable**                              | `enable_queue0` / `DmaPhase::Enabled` after Programmed. Still no TX/RX completion, no vocabulary. Host `QueueEnable` already exists. Gated by [ADR-0105](adr/0105-pi4-nic-backend-boundary.md). | — |
