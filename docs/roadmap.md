...
|  next | **P3/P4 composition residuals**                           | P2 storage now has a product-facing EL0 request/reply endpoint ([ADR-0103](adr/0103-p2-el0-durable-endpoint.md)); future composition work can reuse its separate authority and reply-capability shape. | — |
