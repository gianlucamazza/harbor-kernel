...
| P3  | Network agent + caps                    | **design accepted** — named edge-gateway target over AArch64 QEMU `virt` + virtio-net ([ADR-0104](adr/0104-p3-edge-network-composition.md)); implementation remains open                                                                                                                                                                                                 | Network I/O only via granted caps                    | K1/K9 helpful      | H1 edge → H2 |
