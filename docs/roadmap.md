...
|  next | **GENET descriptor ring 16**                          | Linux `DESC_INDEX` is ring 16 (descriptor-based); rings 0–15 are priority queues. Program and enable ring 16, and ring TX/RX doorbells on that ring's CONS/PROD. Host-tested. QEMU has no successful probe. Silicon unpaid. Not a NIC; ADR-0105/0106 stay proposed. | — |
