...
|  next | **GENET TX/RX complete**                              | Requires BMSR up. Refuse and reset are paid. Absent-device is already the QEMU path (`probe unavailable (no binding)`); this Pi cannot hide the soldered GENET. Not a NIC; ADR-0105/0106 stay proposed. | — |
