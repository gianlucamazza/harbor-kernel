...
| --- | --------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------- | ------------------ | ------------ |
| P1  | Multi-agent product image beyond beacon | **done (HW)** (beacon + chirp + `entropy` in store; first slice stamp 2026-08-11 `n=2`; [ADR-0101](adr/0101-composed-driver-agent.md) grew it to `n=3`, stamp 2026-08-13, transcript `20260813-101713.log` — `?H!R` on the wire when the board has RNG200)                                                                                                 | Product store n≥2; agents run via console endpoint   | ADR-0027/0029      | H1           |
