...
| Cores used        | Dual-current schedule (**K8** queues first **done (QEMU)**, [ADR-0076](adr/0076-k8-per-core-queues-first-slice.md)/[0077](adr/0077-smp-shared-state-discipline.md)); product agents still home on CPU 0; CPU1 runs idle + proof marker |
...
| SMP residual                          | **K8** queues + shared-state discipline **done (QEMU)** (ADR-0076/0077); residual steal / per-core preempt / EL0-on-CPU1 / HW stamp |
