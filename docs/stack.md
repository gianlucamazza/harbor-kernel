...
| Board           | Raspberry Pi 4 Model B (BCM2711), quad-core; dual-current schedule (agents home CPU 0; ADR-0070/0074/0076)      | [`hardware.md`](hardware.md), [ADR-0015](adr/0015-multi-arch-scaffold.md)                                                                                                                                                                     |
...
| Cores used        | Dual-current schedule (**K8** queues first **done (HW)**, [ADR-0076](adr/0076-k8-per-core-queues-first-slice.md)/[0077](adr/0077-smp-shared-state-discipline.md); stamp 2026-08-10); product agents still home on CPU 0; CPU1 runs idle + proof marker |
...
| SMP residual                          | **K8** unpark+IPI+queues first **done (HW)** (ADR-0070/0074/0076/0077, stamp 2026-08-10); per-core timer+EL1 preempt **done (HW)** (ADR-0079, stamp 2026-08-10, `20260810-132749.log`); residual steal / EL0-on-CPU1 |
