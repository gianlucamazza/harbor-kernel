...
The current capture is `.serial-log/20260814-174803.log` (three product boots);
`make hw-check` judges the last. Boot 3 (`src=f7404550`) prints
...
`genet: queue0 programmed (rings, not a nic)` after `frames:` (invariants
...
Cable-down is `link=down`, not a failure. DMA stays disabled.

Boot 2 (`src=ee650e06`) paid link classify. Boot 1 (`src=58b7448c`) paid
PHY identify. The earlier multi-boot capture `20260814-140651.log` paid
FDT + `rev=6.0`. The product capture `20260814-113438.log`
