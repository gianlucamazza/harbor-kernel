...
| ADR-0075            | K8 per-core queues design                     | **Design only** — no status flip. First code residual (follow-on ADR): multi-current + hard affinity + sched lock + SGI0 as RESCHED; core1 preemption deferred. Parent design ADR-0048                                                                                                                                                                                                                         |
