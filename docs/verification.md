...
| ADR-0086            | K5-S Mini stack first slice                   | `density: mini n=… bytes_each=4096` (+ thin still present). Mini = one page, no unmapped guard. QEMU via `boot-oracle.sh`; HW stamp residual                                                                                                                                                                                                                                                             |
