...
The current capture is `.serial-log/20260814-232303.log` (four product
boots with the laptop as link partner); `make hw-check` judges boot 4.
Boot 4 (`src=d53194dc`, PowerOn, RGMII OOB slice) prints
...
RGMII OOB ran; it did not put a frame on the wire. None of those is a
completed frame or a NIC.
