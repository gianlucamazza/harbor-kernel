...
| Starved-host verdict (ADR-0087)                                  | `CPUQuota=15%` and `10%` on the same clean image                                                                                       | `INDETERMINATE` with the share it was decided on (0.13 starved, 0.08 not credible), exit 3 — and clean again at 0.22 and 2.00                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
