...
| ADR-0077            | SMP shared-state discipline                   | Heap + sched + park under `IrqSpinLock`; single `arch::smp` resched; per-CPU mirrors. Exercised on silicon with ADR-0076 stamp (`20260810-130305.log`). Residual: steal / EL0-on-CPU1 (design ADR-0080)                                                                                                                                                                                                            |
...
| ADR-0083            | K8 work-stealing first slice                  | `smp: steal ok` — victim admitted on CPU0 only later runs on affinity 1 (design ADR-0082). **done (QEMU)** via `boot-check`; HW stamp residual                                                                                                                                                                                                                              |
