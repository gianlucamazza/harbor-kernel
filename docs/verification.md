...
| ADR-0070            | K8 first slice (unpark core 1)                | `smp: core1 alive` — QEMU `raspi4b -smp 4` (spin-table PA `0xe0` + in-kernel table). **HW stamp pending**. No per-core runqueue yet (ADR-0048 residual)                                                                                                                                                                                                      |
