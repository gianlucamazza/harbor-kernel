...
| Product boot (`make product-boot-check`)                        | Boots the product image, asserts on the log                       | Boot, console-server up, store agents loaded and ran, oracle strings absent                                                                                                                                                         | Nearly everything the oracle image asserts: ~9 assertions against ~100 — the subsystem invariants (reclaim, timer, refusals, faults) are exercised only in the oracle configuration                                                                                                                                                                              |
