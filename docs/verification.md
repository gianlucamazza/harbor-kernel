...
| ADR-0082            | K8 work-stealing design                       | **Design only** — no status flip. Hard re-home; pull-on-idle; first code EL1-only stealeable (no mid-EL0 / no agent AS without TLB IPI). Code residual (follow-on ADR ~0083)                                                                                                                                                                                                    |
