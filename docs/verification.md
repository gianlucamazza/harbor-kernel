...
| ADR-0080            | K8 EL0-on-CPU1 design                         | **Design only** — no status flip. Per-CPU `CURRENT_EL0`; publish on every affinity; sticky home; EL0 preempt on CPU1 in first code; steal still later. Code residual (follow-on ADR ~0081)                                                                                                                                                                                                                   |
