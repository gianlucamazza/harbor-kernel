...
| ADR-0081            | K8 EL0-on-CPU1 first slice                    | `preempt-el0-cpu1: rotated` + `preempt-el0-cpu1: spinner exited` — per-CPU publish, EL0 quantum on home=1 (design ADR-0080). **done (QEMU)** via `boot-check`; HW stamp residual                                                                                                                                                                                                 |
