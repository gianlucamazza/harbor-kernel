...
| ADR-0105 + ADR-0106 | Pi 4 GENET v5 backend boundary and design | Host: `kernel_core::genet_fdt` validates the distributed Pi 4 DTB binding, ordered MMIO translation, interrupt-parent, PHY and all DMA apertures; `kernel_core::genet` covers descriptor status, ownership, bounded rings, reset generations, queue-0 `RingProgram` (v5 word-unit start/end after descriptor RAM; a packet buffer is never a ring base), and clause-22 `MdioTxn` plus absent PHY-ID refusal. The `genet_emulation` integration test is a deterministic non-hardware TX/RX device-model run that now also programs queue 0 and completes one MDIO read. AArch64 `src/drivers/genet.rs` can write that program and issue `mdio_read`; it is not selected by `board-rpi4`. A 2026-08-14 Pi 4B oracle boot stamp now proves the board baseline, but no GENET-capable QEMU device, bound MMIO backend, or Pi 4 NIC capture exists; GENET remains unclaimed. |
| ------------------- | --------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
