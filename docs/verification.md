...
| ADR                 | Slice                                         | Evidence                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| ADR-0102            | Product binds a name; agent discovers `console` | Host: `may_resolve` bit 8 round-trips while bits 9..31 remain refused; the 52-byte encoder matches the `llvm-mc` oracle. QEMU: `authority: bound console`, `lookup` resolves without an initial console slot and sends `N`; oracle `noresolve` runs the same image with one resolve refusal and no send. |
| ADR-0103            | P2 durable storage endpoint for EL0         | Host: blob wire encode/decode tests. QEMU: product starts the EL1 service, provides and binds `blob`/`blob-reply`, and the five-agent composition records `blob: put ok` plus `blob: got`; `make product-boot-check` is the end-to-end gate. |
| ADR-0104            | P3 edge-gateway network composition         | **Transport, split-ring descriptor lifecycle, and IRQ binding integrated.** `kernel_core::virtio` host tests cover virtio-mmio identity/status validation, modern-feature refusal, checked split-queue arithmetic, directional bounded-pool ownership, malformed lengths, and reset/generation invalidation. `make qemu-virtio-check` boots AArch64 QEMU `virt` with and without `virtio-net-device`, proving DTB mapping, modern negotiation, two EL1-owned split queues (size 8), private EL1 RX/TX buffers, `DRIVER_OK`, TX descriptor submission/completion, retained EL1 frame ownership, 32 slot IRQ bindings, and absent-device refusal. Packet payload delivery, service reset/recovery, directional caps, and end-to-end TX/RX evidence remain open. |
| ------------------- | --------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
