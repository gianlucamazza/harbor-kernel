...
The current capture is `.serial-log/20260814-232303.log` (five product
boots with the laptop as link partner); `make hw-check` judges boot 5.
Boot 5 (`src=6addf8f4`, PowerOn, UniMAC frame slice) prints
...
UniMAC max-frame and station address ran; they did not put a frame on
the wire. None of those is a completed frame or a NIC.
