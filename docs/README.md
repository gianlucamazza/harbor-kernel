...
| **H1 next**             | P3 network implementation for the accepted edge-gateway target ([ADR-0104](adr/0104-p3-edge-network-composition.md)); P2 durable storage is now an EL0 request/reply service ([ADR-0103](adr/0103-p2-el0-durable-endpoint.md))                                                                                                                                           |
