...
| **SMP / ASID / TTBR1**                     | **K7** first slice **done (HW)** (ADR-0050): ASID pool + CONTEXTIDR + nG user leaves; residual TTBR1 / switch-cost measurement. **K8** unpark + IPI + queues first **done (HW)** ([ADR-0070](docs/adr/0070-k8-smp-first-slice.md)/[0074](docs/adr/0074-k8-ipi-wake-second-slice.md)/[0076](docs/adr/0076-k8-per-core-queues-first-slice.md)/[0077](docs/adr/0077-smp-shared-state-discipline.md); Pi stamp 2026-08-10, transcript `20260810-130305.log`); per-core timer + EL1 preempt on CPU 1 **done (HW)** ([ADR-0079](docs/adr/0079-k8-per-core-timer-preemption-first-slice.md); Pi stamp 2026-08-10, transcript `20260810-132749.log`); EL0-on-CPU1 **done (HW)** ([ADR-0081](docs/adr/0081-k8-el0-on-cpu1-first-slice.md); Pi stamp 2026-08-10, transcript `20260810-134826.log`); steal **done (QEMU)** ([ADR-0083](docs/adr/0083-k8-work-stealing-first-slice.md); design [0082](docs/adr/0082-k8-work-stealing-design.md); HW residual). |
