...
| **Today**   | Foundation + H1 depth + K4/K7-first/K8-through-steal + F-R1-P1 on Pi 4B; **K5-S** Mini done (QEMU) [ADR-0086](docs/adr/0086-k5-mini-stack-first-slice.md); residuals (K5-S HW stamp, K5-H/B if trigger [ADR-0085](docs/adr/0085-k5-density-residual-design.md), optional K7-M, agent+TLB steal, P3/P4). See [roadmap](docs/roadmap.md) |
