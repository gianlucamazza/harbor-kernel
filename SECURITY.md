...
| Busy-loop (EL0 or EL1) and starve the system        | **Mitigated** — quantum preemption on the IRQ-return epilogue at both ELs: EL0 ([ADR-0064](docs/adr/0064-k4-el0-preemption-first-slice.md), HW Pi stamp 2026-08-09, `preempt: rotated` on silicon) and EL1 ([ADR-0068](docs/adr/0068-k4-el1-preemption-second-slice.md), QEMU `preempt-el1: rotated`; HW stamp pending). Device IRQ handlers still never switch; masked regions are the non-preemptible sections by construction |
...
| Topic                                      | Status                                                                                                                                                                                                                                                                                                                                                                |
| ------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Preemption**                             | **EL0 IRQ preemption done (HW)** ([ADR-0064](docs/adr/0064-k4-el0-preemption-first-slice.md); Pi stamp 2026-08-09). **EL1 preemption done (QEMU)** ([ADR-0068](docs/adr/0068-k4-el1-preemption-second-slice.md); HW stamp pending). Residual: no priorities, one global quantum; device handlers never switch (by design, ADR-0008).                                  |
