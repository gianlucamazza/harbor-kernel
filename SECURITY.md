...
| Busy-loop at EL0 and starve the system              | **Mitigated (HW, Pi stamp 2026-08-09)** — EL0 IRQ preemption ([ADR-0064](docs/adr/0064-k4-el0-preemption-first-slice.md)): the session loop's IRQ epilogue evaluates the quantum predicate and rotates a spinner off the CPU (`preempt: rotated` on silicon). A busy-loop at **EL1** that never yields remains open until the same-EL slice ([ADR-0051](docs/adr/0051-k4-irq-preemption-design.md)); the cooperative budget ([ADR-0046](docs/adr/0046-k4-cooperative-cpu-budget.md), HW) covers cooperating EL1 workers |
...
| Topic                                      | Status                                                                                                                                                                                                                                                                                                                                                                |
| ------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Preemption**                             | **Cooperative budget done (HW)** ([ADR-0046](docs/adr/0046-k4-cooperative-cpu-budget.md)). **EL0 IRQ preemption done (HW)** ([ADR-0064](docs/adr/0064-k4-el0-preemption-first-slice.md); Pi stamp 2026-08-09). Same-EL (EL1) preemption **in design** ([ADR-0051](docs/adr/0051-k4-irq-preemption-design.md)).                                                        |
