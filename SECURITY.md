...
| **Today**   | Foundation + H1 depth + K4/K7-first/K8-through-steal + F-R1-P1 (+ loader lock) + **K5-S** Mini on Pi 4B; product `home_cpu` + K10 force-exit **done (HW)** ([ADR-0088](docs/adr/0088-product-home-cpu.md)/[0090](docs/adr/0090-k10-force-exit-running.md)); declared composition vocabularies + first store-granted device **done (HW)** ([ADR-0099](docs/adr/0099-composition-vocabulary.md)/[0100](docs/adr/0100-device-windows.md)/[0101](docs/adr/0101-composed-driver-agent.md)); P2 durable endpoint ([ADR-0103](docs/adr/0103-p2-el0-durable-endpoint.md)); P3 edge-gateway target accepted ([ADR-0104](docs/adr/0104-p3-edge-network-composition.md)); K5-B design paid ([ADR-0089](docs/adr/0089-k5-b-pair-collapse-design.md)). Residuals: P3 implementation, P4, K5-H / K5-B **code** if trigger, optional K7-M, agent+TLB steal. See [roadmap](docs/roadmap.md) |
