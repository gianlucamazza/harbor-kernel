...
link, programs and enables queue 0, programs RGMII OOB for `rgmii-rxid`, and may attempt one bounded TX, one bounded RX, and one recover
...
| Evidence     | Today                                                        |
| ------------ | ------------------------------------------------------------ |
| Verification | 589 host tests, model checks, Miri, QEMU and hardware stamps |
