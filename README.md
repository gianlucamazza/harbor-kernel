...
link, programs and enables the descriptor ring (16), programs RGMII OOB for `rgmii-rxid`, programs UniMAC max-frame and station address, and may attempt one bounded TX, one bounded RX, and one recover
