...
link, programs and enables queue 0, and may attempt one bounded TX, one bounded RX, and one recover
...
| Evidence     | Today                                                        |
| ------------ | ------------------------------------------------------------ |
| Verification | 588 host tests, model checks, Miri, QEMU and hardware stamps |
