...
link, programs and enables queue 0, programs RGMII OOB for `rgmii-rxid`, programs UniMAC max-frame and station address, and may attempt one bounded TX, one bounded RX, and one recover
