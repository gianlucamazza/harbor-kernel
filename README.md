...
| **Next**            | K8 preempt-on-CPU1 **HW stamp** ([ADR-0079](docs/adr/0079-k8-per-core-timer-preemption-first-slice.md); QEMU paid) — [roadmap](docs/roadmap.md)                                                                                                      |
...
| Execution    | Voluntary primary + IRQ-epilogue preemption (EL0+EL1, ADR-0064/0068; CPU1 EL1 **done (QEMU)** ADR-0079); K8 unpark+IPI+queues first **done (HW)** (ADR-0070/0074/0076/0077, stamp 2026-08-10); product agents still home CPU 0 |
